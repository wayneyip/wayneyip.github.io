...
const outlineDetails = [
  {
    imgSrc: "pixel/outline_vertcolors.png", 
  ...
  {
    imgSrc: "pixel/outline_lines.png", 
  ...
  {
    imgSrc: "pixel/outline_light.png", 
  ...
  {
    imgSrc: "pixel/outline_final.png", 
        ...
        <div className="flex-grow">
          <div className="max-w-screen-lg mx-auto px-4 py-20">
            ...
            <video className="w-full mx-auto mb-8" autoPlay loop muted playsInline> 
            	<source src="pixel/main.mp4" type="video/mp4" />
          	</video>
